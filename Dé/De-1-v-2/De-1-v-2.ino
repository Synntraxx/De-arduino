...
void RandomValue() {
  ...
  if (buttonState == HIGH) {
   ...
   for (int i = 0; i <= 30; i++) {
    RandomValuePixelFonct();
    pixels.setPixelColor(RandomValuePixel, pixels.Color(0, 100, 0));
    pixels.show();
    delay(30);
    pixels.clear();
  }
...
void RandomValuePixelFonct() {
  RandomValuePixel = random(1, 7);
  return RandomValuePixel;
}
